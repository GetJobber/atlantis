---
name: In-product word list
menu: Guides
route: /guides/in-product-word-list
---
...
<img
  src="/public/assets/images/in-product-words/addvscreate.png"
  style={{ maxWidth: "100%" }}
/>
...
### change / edit / manage / update

Use **change** when the user is replacing an item with a new one. There's no
need for a noun after change unless it's unclear what is being affected.

| **✅ Do **        | **❌ Don't**     |
| ----------------- | ---------------- |
| Change your plan  | Manage your plan |
| Change password   | Edit password    |
| Change PDF style  | Update PDF style |
| Change job number | Edit job number  |

Use **edit** when user is making unspecified changes to an item, or in reference
to the Edit permission level.

| **✅ Do **          | **❌ Don't**          |
| ------------------- | --------------------- |
| Edit Quote          | Update Quote          |
| Edit Invoice        | Change Invoice        |
| Edit Client Details | Manage Client Details |

Use **manage** when communicating several settings that can be changed on a view
or page.

| **✅ Do **                 | **❌ Don't**               |
| -------------------------- | -------------------------- |
| Manage Team                | Edit Team                  |
| Manage Products & Services | Update Products & Services |
| Manage Notifications       | Edit Notifications         |

Use **update** only when an action has a cascading effect (ie. Update future
visits).
...
Use **choose** when presenting a subjective choice

| **✅ Do **      | **❌ Don't**    |
| --------------- | --------------- |
| Choose Theme    | Select Theme    |
| Choose Template | Select Template |
| Choose a Plan   | Select Plan     |

Use **select** when presenting a set of limited options with an obvious answer

| **✅ Do **     | **❌ Don't**   |
| -------------- | -------------- |
| Select Invoice | Choose Invoice |
| Select Country | Choose Country |
| Select File    | Choose file    |

---

### click / click here / tap / press

Avoid telling users where to click or tap in an interface and make direct
reference to the call to action and component instead

| **✅ Do **                                      | **❌ Don't**                            |
| ----------------------------------------------- | --------------------------------------- |
| View the sample's details in the following list | Click on the sample to view its details |

When difficult to avoid, use **press** instead of **tap** or **click** as the
more inclusive term for different ways a user can interact with a device.

| **✅ Do **           | **❌ Don't**       |
| -------------------- | ------------------ |
| Press the Add button | Tap the Add button |
...
Always refer to our service consumer portal as client hub. Stick to sentence
case, as it is a general term, not branded.

| **✅ Do **                            | **❌ Don't**                          |
| ------------------------------------- | ------------------------------------- |
| Changes will be visible in client hub | Changes will be visible in Client Hub |
...
Use **got it** as a call to action \*\*\*\*when a user can acknowledge a message
without taking action on it, like in promo cards or onboarding.

---

### help center / help docs / help documentation / learn more

Use Help Center exclusively when linking to additional help documentation.

| **✅ Do **                                                              | **❌ Don't**                                                            |
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Learn how disputes work and how to prevent them in our [Help Center](#) | Learn how disputes work and how to prevent them in our [Help Center](#) |
|                                                                         | Want to know how disputes work and how to prevent them? [Learn more](#) |
...
Use **product / service** as labels for the name and description of individual
line items, or when referring to the list of them available outside of an
individual quote, job or invoice.
...
| **✅ Do**                                                  | **❌ Don't**                                               |
| ---------------------------------------------------------- | ---------------------------------------------------------- |
| Attach a receipt to this expense <br /> [Select a file](#) | Attach a receipt to this expense <br /> [Attach a file](#) |
...
Use **products and services** (and avoid flipping the words) in body text, and
...
| **✅ Do**            | **❌ Don't**       |
| -------------------- | ------------------ |
| Update Company Hours | Save Company Hours |
...
Generally avoid referring to Jobber as **we** in the interface itself - focus on
the user and what they can do rather than on Jobber.
...
Only use **we** when we are actually performing an action for the user or making
a suggestion.

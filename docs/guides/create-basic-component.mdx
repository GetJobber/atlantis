...
- Added a `styles.button` class name so I can reset the styling of the buttons.
...
- Talk about handle and callback functions
- Controlled and uncontrolled components
- Show and explain how we can make this component a controlled component
- Done!

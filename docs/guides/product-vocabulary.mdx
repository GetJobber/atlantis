...
menu: Guides
route: /guides/product-vocabulary
---
...
| **✅ Do **                                                                                | **❌ Don't**                                                                             |
| ----------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| Learn how disputes work and how to prevent them in our [Help Center](#concepts-and-items) | ant to know how disputes work and how to prevent them? [Learn more](#concepts-and-items) |

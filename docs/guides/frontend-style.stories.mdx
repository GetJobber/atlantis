...
This can be seen in
[Modal](../?path=/docs/components-overlays-modal-docs--page),
[Drawer](../?path=/docs/components-layouts-and-structure-drawer-docs--page), and
...
For spacing units (margins and padding), use the appropriate
[Spacing](../?path=/docs/design-spacing--page) values. Do not use rems, ems, or
...
In most cases, the dimensions (width and height) of an individual component will
be determined by the content and spacing. However, sometimes you'll reasonably
want to say something like "this component should be a minimum of 280px wide".

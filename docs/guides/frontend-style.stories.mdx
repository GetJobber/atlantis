...
- the `size` properties of
  <a href="../?path=/docs/components-button--button">Button</a>,
  <a href="../?path=/docs/components-avatar--avatar">Avatar</a>, <a href="../?path=/docs/components-inputtext--input-text">
    InputText
  </a>,<a href="../?path=/docs/components-text--text">Text</a>,<a href="../?path=/docs/components-progressbar--progress-bar">
    ProgressBar
  </a>, <a href="../?path=/docs/components-spinner--spinner">Spinner</a>, etc;
- `maxLines` of <a href="../?path=/docs/components-text--text">Text</a>
- values of <a href="../?path=/docs/design-elevations--page">Shadow</a>,
  <a href="../?path=/docs/design-spacing--page">Spacing</a>,
  <a href="../?path=/docs/design-borders--page">Border Radius</a> design tokens
...
This can be seen in <a href="../?path=/docs/components-modal--modal">Modal</a>,
<a href="../?path=/docs/components-drawer--drawer">Drawer</a>, and
...
<a href="../?path=/docs/design-spacing--page">Spacing</a> variables. Do not use

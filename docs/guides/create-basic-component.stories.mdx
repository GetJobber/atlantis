...
- **Paragraph**: We can use the [Text](../?path=/docs/components-text--text)
  component
- **Input**: We need an input that can only accept number. We can use the
  [InputNumber](../?path=/docs/components-inputnumber--input-number) component
...
- Used the [Icon](../?path=/docs/components-icon--icon) component instead of `+`
  or `-`.
- Check out the
  [InputNumber](../?path=/docs/components-inputnumber--input-number#properties)

...
[Emphasis](../?path=/docs/components-text-and-typography-emphasis-docs--page) to
...
[Sizes](../?path=/docs/components-text-and-typography-text-docs--page#sizes)
section of the Text component.

...
### enable / disable / turn on / turn off / connect / disconnect / activate / deactivate
...
When referencing user management, use **reactivate** and
**deactivate** for controlling their account access.

| **✅ Do**         | **❌ Don't**      |
| ----------------- | ----------------- |
| Deactivate user | Disable user |

When referencing automations or automated campaigns, use **activate**, 
**deactivate**, and **reactivate** for managing automation statuses.

| **✅ Do**         | **❌ Don't**      |
| ----------------- | ----------------- |
| Deactivate automation | Disable automation |
<br />

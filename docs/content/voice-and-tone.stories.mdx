...
Our full
[Voice & Tone guidelines](https://docs.google.com/document/d/136CPyjDordlEGLgo1UBPRNy-rw2MMvyh35eCdRK8fJM/edit?usp=sharing)
...
Explain what happened, and how to address the issue in a concise manner. If you
can't be specific, be general without being overly technical.

Avoid blaming the user in form validations - focus on the fix.

Empathize with the user - this probably isn't a great time for jokes.

| ✅ **Do**                                                          | ❌ **Don't**                                  |
| ------------------------------------------------------------------ | --------------------------------------------- |
| 555-555-5555 is already on file for this client                    | Duplicate value detected                      |
| Something went wrong. [Return to Home](/)                          | Error 140024 (Unauthorized)                   |
| Password must be at least 12 characters                            | Invalid: minimum string length 12             |
| Jobber is currently unavailable. Contact support at 1-888-721-1115 | Whoopsie! The servers are taking a little nap |

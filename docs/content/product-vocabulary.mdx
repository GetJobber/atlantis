...
Use **refresh** in error messages or on error banner actions, for system or connectivity errors. Although 'Reload' and 'Refresh' have the same meaning, use 'Refresh' for consistency.

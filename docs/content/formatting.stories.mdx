...
Minimize the use of decimal places in numbers unless essential. Begin
abbreviating numbers at ten thousand when precision is not crucial.
...
Examples of essential decimal places include payment-related details, accounting
statements, measurements, and reporting tables where exact amounts may be
required.

| ✅ **Do**                      | ❌ **Don't**             |
| ------------------------------ | ------------------------ |
| Balance: **$489.62**           | Balance: **$489**        |
| Received payment for $5,240.18 | Received payment for $5k |

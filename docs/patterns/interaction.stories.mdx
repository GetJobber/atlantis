...
- For guidance on disabled states, see the
  [Disabled States](../patterns/disabled-states) pattern.
- For guidance on use of color tokens for interactive statess, see the
  [Color](../design/color) docs.

...
<Meta title="Components/Images and Icons/FormatFile" component={FormatFile} />
...
- Use [Avatar](../components/avatar) for a thumbnail representation of a user
- Use [Gallery](../components/gallery) for a list of thumbnails that open in a
  Lightbox
- Use [Lightbox]](../components/lightbox) to open an image in a focused viewing
  modal

...
Otherwise, use
[Toast](../?path=/docs/components-status-and-feedback-toast-docs--page) as the
default for success messages.

#### Success messages (mobile)

On mobile, use
[Toast](../?path=/docs/components-status-and-feedback-toast-docs--page) for a
success message.
...
- To provide low priority, temporary feedback on the outcome of a user action,
  use [Toast](../?path=/docs/components-status-and-feedback-toast-docs--page)
  instead.
- Use
  [ConfirmationModal](../?path=/docs/components-overlays-confirmationmodal-docs--page)

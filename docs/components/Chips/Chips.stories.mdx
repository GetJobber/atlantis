...
- [Chip](../?path=/docs/components-selections-chip--docs) is the building block that Chips is built on top of, and has more 
  flexibility to be used in isolation.
...
### Chips Composition with Standalone Chip (Web)
...
Rather than using the standalone implementation.

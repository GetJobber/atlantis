...
const ExternalLabelTemplate: ComponentStory<typeof InputNumber2> = args => {
  return (
    <div>
      <FormFieldLabel external={true} htmlFor="ext-input">
        External label
      </FormFieldLabel>
      <InputNumber2 id="ext-input" {...args} />
    </div>
  );
};
...
const FocusTemplate: ComponentStory<typeof InputNumber2> = args => {
  const inputNumberRef = useRef<InputNumber2Ref>(null);
  ...
  return (
    <Content>
      <InputNumber2 {...args} value={5.0} ref={inputNumberRef} />
...
const ControlledTemplate: ComponentStory<typeof InputNumber2> = args => {
  ...
  return (
    <Box gap="base">
      <InputNumber2 {...args} value={value} onChange={v => setValue(v)} />

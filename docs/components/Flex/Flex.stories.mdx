...
[Grid](../?path=/docs/components-layouts-and-structure-grid-docs--page). Flex
should be used in Web to achieve alignments and layouts inside a component that
aren't possible with Grid.

...
functionality will also remain the same, only the appearance will change if a
custom section is provided.
...
function is provided. The same is true of the `customSectionStyles`.

...
For the resting background color: `--public-chip-base-active-bg-color`

For the hover/focused background color:
`--public-chip-base-active-hover-bg-color`

For the text content and miscellaneous content such as the line separator
between the `label` and `heading`: `--public-chip-base-active-content-color`

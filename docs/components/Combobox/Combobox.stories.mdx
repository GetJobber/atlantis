...
[StatusIndicator](../?path=/docs/components-status-and-feedback-statusindicator-docs--page)
or [Icon](../?path=/docs/components-images-and-icons-icon-docs--page) to provide
...
When using a custom activator, it is important to ensure that the activator
provides information to provide Assistive technology.

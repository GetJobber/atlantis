...
selected. Examples of using a default activator can be found in the
...
Notice that omitting an activator subcomponent will result in the default
activator being used.

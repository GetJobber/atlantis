...
`keepOpenOnActionClick` prop. An example of this behaviour can be found in the
[Keep Open on Action Click](../?path=/story/components-selections-combobox-web--keep-open-on-action-click)
story.

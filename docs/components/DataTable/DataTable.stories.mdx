...
(sorting, filtering, pagination, etc.) with our atomic components to fully
control the behavior and layout. The atomic components provide layout and
styling only — they do not prescribe any data logic or behavior.

...
Use a
[controlled](../?path=/story/components-selections-segmentedcontrol-web--basic-controlled)
...
Use an
[uncontrolled](../?path=/story/components-selections-segmentedcontrol-web--basic-uncontrolled)
...
Unlike
[Switch](..https://atlantis.getjobber.com/?path=/docs/components-selections-switch--docs),
which toggles between a simple On/Off state, the SegmentedControl offers more
than two options.

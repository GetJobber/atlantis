...
<Meta title="Components/Actions/Button/Docs" component={Button} />
...
[Form](../?path=/docs/components-forms-and-inputs-form-docs--page). Since
submitting a form is a specific action, only `variation="work"` and
`type="primary"` are allowed. See

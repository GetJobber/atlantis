...
<Meta title="Components/Images and Icons/Icon/Docs" component={Icon} />
...
[small Button.](../?path=/docs/components-actions-button-docs--page#sizes)
...
components, such as
[List](../?path=/docs/components-lists-and-tables-list-docs--page), is the
...
| <Icon name="casual" />       | `casual`       |
| <Icon name="checkmark" />    | `checkmark`    |
| <Icon name="cheerful" />     | `cheerful`     |
| <Icon name="cog" />          | `cog`          |

...
A single checkbox, a
<a href="../?path=/docs/components-switch--switch-story">Switch</a>, and a pair
of <a href="../?path=/docs/components-radiogroup--radio-group">radio buttons</a>
...
- To present a set of options where people can only make a single choice, use a
  <a href="../?path=/docs/components-radiogroup--radio-group">Radio Group</a>.

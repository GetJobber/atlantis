...
const BasicTemplate: StoryFn<typeof Checkbox> = args => {
...
const Invalid_v2Template: StoryFn<typeof Checkbox> = args => {
  const [checked, setChecked] = useState(true);

  return <Checkbox {...args} checked={checked} onChange={setChecked} />;
};

export const Invalid_v2 = {
...
const IndeterminateTemplate: StoryFn<typeof Checkbox> = () => {
...
const ChildrenAsLabelTemplate: StoryFn<typeof Checkbox> = args => {

...
type SideDrawerStoryArgs = Pick<
  React.ComponentProps<typeof SideDrawer>,
  "open"
>;

const meta = {
  title: "Components/Overlays/SideDrawer",
  component: SideDrawer,
} satisfies Meta<typeof SideDrawer>;

export default meta;

type Story = StoryObj<SideDrawerStoryArgs>;

export const Basic: Story = {
  render: args => {
    const [sideDrawerOpen, setSideDrawerOpen] = useState(args?.open ?? true);
        ...
        >
          ...
          <Content>
            ...
            <Text>
              ...
              Voluptates obcaecati debitis animi ullam dicta consectetur,
              dolorem nemo itaque enim aperiam!
            </Text>
          </Content>
          ...
          <Tabs>
            ...
            <Tab label="Cheese">
              ...
              a wide range of flavors, textures, and forms by coagulation of the
              milk protein casein.
            </Tab>
            <Tab label="Berries">
    ...
    return (
      <>
        ...
        >
          ...
          <Content>
            <Text>
              If you need more control over what shows up on the heading, you
              can pass in a custom element in SideDrawer.Title
            </Text>
          </Content>
        </SideDrawer>
      </>

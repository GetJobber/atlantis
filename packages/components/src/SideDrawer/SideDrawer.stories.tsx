...
const BasicTemplate: StoryFn<typeof SideDrawer> = args => {
...
const ActionTemplate: StoryFn<typeof SideDrawer> = args => {
  const [sideDrawerOpen, setSideDrawerOpen] = useState(args.open);
...
const CustomTitleTemplate: StoryFn<typeof SideDrawer> = args => {
  const [sideDrawerOpen, setSideDrawerOpen] = useState(args.open);
...
const ToolbarTemplate: StoryFn<typeof SideDrawer> = args => {
  const [sideDrawerOpen, setSideDrawerOpen] = useState(args.open);
...
const BackButtonTemplate: StoryFn<typeof SideDrawer> = args => {
  const [sideDrawerOpen, setSideDrawerOpen] = useState(args.open);
...
const InlineTemplate: StoryFn<typeof SideDrawer> = args => {

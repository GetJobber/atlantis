...
Adding a prop for `OnClick` was considered, but decided against with no clear
use case that wasn't better served by other components for triggering actions or
other events for handling the outcome of clicking a link (leaving the page)

...
<Playground>
  <Button label="Learn More" type="learning" />
  <Button label="Learn More" type="learning" variation="secondary" />
  <Button label="Learn More" type="learning" variation="tertiary" />
</Playground>

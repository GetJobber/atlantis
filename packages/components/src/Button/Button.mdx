...
<Playground>
  <div style={{ backgroundColor:"var(--color-surface--background)", padding:"var(--space-base)" }}>
    ...
    <Button label="Cancel" type="primary" variation="cancel" />
    <Button label="Cancel" type="secondary" variation="cancel" />
    <Button label="Cancel" type="tertiary" variation="cancel" />

    <Button variation="cancel" type="tertiary" icon="search" aria-label="search" />
    <Button variation="cancel" type="tertiary" icon="cog" aria-label="settings" />
    <Button variation="cancel" type="tertiary" icon="help" aria-label="help" />
    <Button variation="cancel" type="tertiary" icon="more" aria-label="more" />

      ...
      columns={[
        {
          ...
          header: () => (
            <span style={{ color: "var(--color-blue)" }}>Name</span>
          ),
        },
        {
          accessorKey: "house",
          header: () => (
            <span style={{ color: "var(--color-blue)" }}>House</span>
          ),
        },
        {
          accessorKey: "region",
          header: () => (
            <span style={{ color: "var(--color-blue)" }}>Region</span>
          ),
        },
        {
          accessorKey: "sigil",
          header: () => (
            <span style={{ color: "var(--color-blue)" }}>Sigil</span>
          ),
        },
        {
          accessorKey: "isAlive",
          ...
          header: () => (
            <span style={{ color: "var(--color-blue)" }}>Alive</span>
          ),
        },
      ]}
    />

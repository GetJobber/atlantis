...
const BasicTemplate: StoryFn<typeof DataTable> = args => (
  <DataTable {...args} />
);
...
const WithActionsTemplate: StoryFn<typeof DataTable> = args => (
  <DataTable
    {...args}
    columns={[
      {
...
const HorizontalScrollingTemplate: StoryFn<typeof DataTable> = args => (
...
const ManualSortingTemplate: StoryFn<typeof DataTable> = args => {
...
const WithFooterRowTemplate: StoryFn<typeof DataTable> = args => (
  <DataTable
    {...args}
    columns={[
      {
...
const EmptyStateTemplate: StoryFn<typeof DataTable> = args => (
  <DataTable
    {...args}
    emptyState={
      <div>
...
const LoadingTemplate: StoryFn<typeof DataTable> = args => (
  <DataTable
    {...args}
    columns={[
      {

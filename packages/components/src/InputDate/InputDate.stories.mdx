...
[Datepicker](../?path=/docs/components-datepicker--date-picker#accessibility) is
keyboard-operable and announces the currently-focused date available for
...
- If you do not need an accompanying form field, you can use the
  [Datepicker](../?path=/docs/components-datepicker--date-picker) on its own

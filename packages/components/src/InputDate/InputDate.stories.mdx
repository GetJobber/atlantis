...
<a href="?path=/docs/components-datepicker--date-picker#accessibility">
  Datepicker
</a> is keyboard-operable and announces the currently-focused date available for
...
If used in an
<a href="../?path=/docs/components-inputgroup--input-group">InputGroup</a>, it
...
- If you do not need an accompanying form field, you can use the
  <a href="../?path=/docs/components-datepicker--date-picker">Datepicker</a> on
  its own
- If you need to allow the user to enter time, use
  <a href="../?path=/docs/components-inputtime--input-time">InputTime</a>

...
function DatePickerActivator({
  ...
  readonly activatorProps: DatePickerActivatorProps;
  readonly inputProps: InputDateProps;
}) {
  ...
  return (
    ...
    <div onClick={onClick}>
      <FormField
        {...newActivatorProps}
        {...inputProps}
        value={showEmptyValueLabel ? inputProps.emptyValueLabel || "" : value}
        ...
        onKeyUp={event => {
          if (inputProps.showIcon === false && event.key === "ArrowDown") {

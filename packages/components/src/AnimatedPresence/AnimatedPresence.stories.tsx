...
} as Meta<typeof AnimatedPresence>;

const BasicTemplate: StoryFn<typeof AnimatedPresence> = args => {
...
const ListTemplate: StoryFn<typeof AnimatedPresence> = args => {
...
const StepperTemplate: StoryFn<typeof AnimatedPresence> = args => {

...
To list more complex collections of information, you may want to consider the [List](https://atlantis.getjobber.com/components/list) component. If you have a small list of information with a 1:1 label-to-data relationship (for example, the issued and due dates on an invoice), consider using [DescriptionList](https://atlantis.getjobber.com/components/description-list).

...
<Playground>
  <Markdown content={`# Bananas
    ...
    Bananas are **yellow** on the outside and **white** on the inside. It's also full of nutrients, _but thats just boring stuff_.

    ## Types of bananas

    At this point, I'll just ask you to [google it](https://lmgtfy.com/?q=types+of+bananas)`} />

...
- Design within a 24px grid
- Line weight should be 2px
- Corners should be rounded to a 1px radius
- When a line is interrupted, use geometric/square terminals 
- when a line ends organically, use round terminals

...
[small Button.](/components/button/#small)
...
components, such as [List](/components/list), is the responsibility of those
other components.
...
such as ["destructive"](/colors#destructive) specify the system color for the
icon when it is added to Atlantis. In all other cases, use the default icon
color.

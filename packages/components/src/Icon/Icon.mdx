...
| <Icon name="attachment" /> | `attachment` |
...
| Icon                         | `Name`         |
| :--------------------------- | :------------- |
| <Icon name="ePayment" />     | `ePayment`     |
| <Icon name="payment" />      | `payment`      |
| <Icon name="percent" />      | `percent`      |
| <Icon name="shoppingCart" /> | `shoppingCart` |
...
| <Icon name="management" /> | `management` |
| <Icon name="menu" />       | `menu`       |

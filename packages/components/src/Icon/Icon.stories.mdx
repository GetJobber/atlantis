...
<a href="../?path=/docs/components-button--button#sizes">small Button.</a>
...
components, such as <a href="../?path=/docs/components-list--list">List</a>, is
the responsibility of those other components.
...
such as
<a href="../?path=/docs/design-colors--page#destructive">"destructive"</a>
specify the system color for the icon when it is added to Atlantis. In all other
cases, use the default icon color.

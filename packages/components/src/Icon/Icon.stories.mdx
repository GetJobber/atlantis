...
[small Button.](/docs/components-button--button#sizes)
...
components, such as [List](/docs/components-list--list), is the responsibility
...
such as ["destructive"](/docs/design-colors--page#destructive) specify the
system color for the icon when it is added to Atlantis. In all other cases, use

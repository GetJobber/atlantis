...
<a href="../?path=/docs/components-heading--heading">Heading</a> or
<a href="../?path=/docs/components-text--text">Text</a> to achieve the desired
typographic treatment for your use case.
...
- To display a unit of time that has already passed, use
  <a href="../?path=/docs/components-formatrelativedatetime--format-relative-date-time">FormatRelativeDateTime</a>
- To display time as a static unit, use
  <a href="../?path=/docs/components-formattime--format-time">FormatTime</a>

...
<Meta title="Components/Utilities/Countdown" component={Countdown} />
...
[Heading](../?path=/docs/components-text-and-typography-heading-docs--page) or
[Text](../?path=/docs/components-text-and-typography-text-docs--page) to achieve
the desired typographic treatment for your use case.

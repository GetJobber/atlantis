...
see the <a href="../?path=/docs/components-inputtext--input-text">InputText</a>
documentation.
...
practice to use the
<a href="../?path=/docs/hooks-useformstate--use-form-state">`useFormState`</a>
hook with the `onStateChange` prop.

...
const SizesTemplate: StoryFn<typeof InputNumber> = () => {
  return (
    <Content>
...
const InlineTemplate: StoryFn<typeof InputNumber> = args => {
...
const FocusTemplate: StoryFn<typeof InputNumber> = args => {
...
const ReadonlyTemplate: StoryFn<typeof InputNumber> = args => {
  return <InputNumber {...args} />;
};
...
const DisabledTemplate: StoryFn<typeof InputNumber> = args => {
  return <InputNumber {...args} />;
};
...
const PrefixAndSuffixTemplate: StoryFn<typeof InputNumber> = args => {
  return <InputNumber {...args} />;
};
...
const ControlledTemplate: StoryFn<typeof InputNumber> = args => {
...
const FormattingExamplesTemplate: StoryFn<typeof InputNumber> = args => {
...
export const FormattingExamples_v2Only = {

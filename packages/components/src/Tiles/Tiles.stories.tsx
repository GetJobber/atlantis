...
const BasicTemplate: StoryFn<typeof Tiles> = args => (
  <Tiles {...args}>
    <Card>
      <Box padding="base">
...
const ContentTemplate: StoryFn<typeof Tiles> = args => (
  <Tiles {...args}>
    <Card>
      <Box padding="base">
        <Text>
...
const AlignmentTemplate: StoryFn<typeof Tiles> = () => (

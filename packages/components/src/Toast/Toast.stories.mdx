...
length or CTA, use
<a href="../?path=/docs/components-banner--banner">Banner.</a>
...
Use <a href="../?path=/docs/components-banner--banner">Banner</a> and, where
necessary, targeted error messaging (such as
<a href="../?path=/docs/components-inputvalidation--input-validation">InputValidation</a>)

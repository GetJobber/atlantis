...
Only use Toast for errors if there is some other mechanism alerting the user of the problem (ie InlineValidation)
...
For more persistent feedback, or for feedback that has a longer reading legth or CTA, use [Banner.](banner)

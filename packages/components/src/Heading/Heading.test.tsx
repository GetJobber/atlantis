...
it("renders a Heading 1", () => {
  ...
  expect(tree).toMatchInlineSnapshot(`
    <h1
      className="base jumbo black uppercase blue"
    >
      Dis be a Heading 1
    </h1>
  `);
...
it("renders a Heading 2", () => {
  ...
  expect(tree).toMatchInlineSnapshot(`
    <h2
      className="base largest black uppercase blue"
    >
      Dis be a Heading 2
    </h2>
  `);
...
it("renders a Heading 3", () => {
  ...
  expect(tree).toMatchInlineSnapshot(`
    <h3
      className="base larger bold blue"
    >
      Dis be a Heading 3
    </h3>
  `);
...
it("renders a Heading 4", () => {
  ...
  expect(tree).toMatchInlineSnapshot(`
    <h4
      className="base large bold blue"
    >
      Dis be a Heading 4
    </h4>
  `);

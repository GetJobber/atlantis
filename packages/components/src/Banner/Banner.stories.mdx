...
<a href="../?path=/story/components-content--content">Content</a> to ensure consistent
...
Otherwise, use <a href="../?path=/docs/components-toast--toast">toasts</a> as
the default for success messages.
...
<a href="../?path=/docs/components-confirmationmodal--confirmation-modal">
  ConfirmationModal
</a> when you need to get explicit confirmation from the user before they complete
...
of the
<a href="../?path=/docs/components-inputtext--input-text#validation-message">InputText
validation message</a> component or, if unavailable,
<a href="../?path=/docs/components-inputvalidation--input-validation">input
validation</a>.

For more guidance on wording, check out the
<a href="../?path=/docs/content-product-vocabulary--page">Product
Vocabulary</a>.
...
- Follow the <a href="../?path=/docs/content-product-vocabulary--page">product
  vocabulary</a> where applicable
...
- To provide low priority, temporary feedback on the outcome of a user action,
  use <a href="../?path=/docs/components-toast--toast">Toast</a> instead
- Use
  <a href="../?path=/docs/components-confirmationmodal--confirmation-modal">ConfirmationModal</a>

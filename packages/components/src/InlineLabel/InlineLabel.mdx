...
Inline labels can be used fairly broadly, but the application of [color](#colors)
should be handled with intent. Use of colour along with a descriptive label
can help the user understand the meaning of an item's status.

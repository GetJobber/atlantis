...
const BasicTemplate: StoryFn<typeof Popover> = args => {
...
const InformationalTemplate: StoryFn<typeof Popover> = args => {
...
const ComposedTemplate: StoryFn<typeof Popover> = args => {
...
const ForceInverseThemeTemplate: StoryFn<typeof Popover> = args => {
  const divRef1 = useRef<HTMLDivElement>(null);
  const [showPopover1, setShowPopover1] = useState(args.open);
  const buttonStyles = { width: "fit-content" };
...
export const ForceInverseTheme = {

...
const BasicTemplate: StoryFn<typeof List> = args => (
  <Card>
    <List {...args} />
  </Card>
);

const SimpleTemplate: StoryFn<typeof List> = args => (
...
export const SectionedListItems = {
  render: BasicTemplate,
...
export const ListWithCustomRenderer = {
  render: BasicTemplate,
  args: {
...
export const SectionedListWithCustomItem = {
  render: BasicTemplate,
  args: {
    items: productsList,
...
export const SectionedListWithCustomSection = {
  render: BasicTemplate,
  args: {
...
export const SimpleListWithCustomStyles = {

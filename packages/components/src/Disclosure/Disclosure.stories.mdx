...
<ArgsTable of={Disclosure} story="Disclosure" />
...
- We may, in the future, set up an onChange handler that receives
  expanded/collapsed events. For example, other parts of a page, SPA or not, can
  subscribe to this and react accordingly.

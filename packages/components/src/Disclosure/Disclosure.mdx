...
<Playground>
  <Disclosure title="Open to see more content organa palpatine lobot jawa kamino.">
    <Content>
      <p>
        Lucas ipsum dolor sit amet darth sebulba solo vader yoda bothan wedge
        kenobi dantooine hutt.
      </p>
      <p>
...
The `<Disclosure>` will reveal and hide additional information that our users
...
<iframe
  ...
  width="800"
  height="450"
  src="https://www.figma.com/file/NSFGqkxgycP8JbEwmaDW8d/Design-System-Contribution-%5BDisclosure%5D?node-id=456%3A3679"
  allowfullscreen
></iframe>

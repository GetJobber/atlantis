...
<a href="../?path=/docs/components-inlinelabel--inline-label">InlineLabel</a>
...
For example, in a <a href="../?path=/docs/components-list--list">List</a> where
the StatusLabel is on the right, use the `end` alignment.
...
- <a href="../?path=/docs/components-inlinelabel--inline-label">InlineLabel</a> should
  be replaced with StatusLabel where possible to provide a more intentional communication
  of status to users

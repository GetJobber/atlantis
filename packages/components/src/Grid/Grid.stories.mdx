...
For example, you have a 3 column grid that goes side by side with a 50/25/25
split on medium-sized screens and up. But, on a small-sized screen, it stacks on
top of each other.

...
Separators which appear as a bottom border are applied when at least one option
has a decription or details field.
    ...
    const options = [
      {
        value: 1,
        label: "Sulaco",
        desription: "They mostly come at night, mostly."
      },
      { value: 2, label: "Nostromo", details: "LV-426" },
      { value: 3, label: "Serenity" },
      { value: 4, label: "Sleeper Service" },

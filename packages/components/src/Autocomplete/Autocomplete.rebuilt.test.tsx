...
describe("AutocompleteRebuilt", () => {
  ...
  describe("advanced blur and focus management", () => {
    ...
    it("prevents blur when clicking an option", async () => {
      const onBlur = jest.fn();
    ...
    it("prevents blur when clicking an action", async () => {
      const onBlur = jest.fn();
    ...
    it("prevents blur when clicking interactive header", async () => {
      const onBlur = jest.fn();
      const onHeaderClick = jest.fn();
    ...
    it("prevents blur when clicking interactive footer", async () => {
      const onBlur = jest.fn();

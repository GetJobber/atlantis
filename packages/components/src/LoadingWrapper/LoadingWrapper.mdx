...
name: LoadingWrapper
menu: Components
route: /components/loading-wrapper
...
```ts
import { LoadingWrapper } from "@jobber/components/LoadingWrapper";
```
...
<Playground>
  {() => {
    ...
    return (
      <>
        <LoadingWrapper variant="spinner" isLoading={isLoading}>
          <p>Loading Content Here</p>
        </LoadingWrapper>
        <Button
          label="Change Loading State"
...
<Playground>
  {() => {
    ...
    return (
      <>
        <LoadingWrapper variant="bar" isLoading={isLoading} progress={progress}>
          <p>Loading Content Here</p>
        </LoadingWrapper>
        <Button
          label="Change Loading State"
...
The `<LoadingWrapper>` will... _Add a brief description of the component_

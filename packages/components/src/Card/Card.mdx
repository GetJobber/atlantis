...
A card is used to group related information and tasks so our users can scan 
...
A card is useful for grouping content because of it's distinct visual boundaries. However, similar to the idea that "making everything stand out means that nothing stands out", you should be mindful in your application of cards.

...
<Banner type="warning" dismissible={false}>
  ...
  <a href="../?path=/docs/components-inputtext--input-text/#validation-message">
...
[input's built-in validation](../?path=/docs/components-inputtext--input-text/#validation-message)

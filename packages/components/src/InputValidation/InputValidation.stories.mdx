...
<a href="../?path=/docs/components-inputtext--input-text#validation-message">input's
built-in validation</a> is not available, such as in `inline` usage.

For more information about `validations` using any of the `Input` components,
see the
<a href="../?path=/docs/components-inputtext--input-textt#validation-message">InputText</a>
documentation.

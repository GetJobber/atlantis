...
const BasicTemplate: StoryFn<typeof InputText> = args => {
  return <InputText {...args} />;
};

const ExternalLabelTemplate: StoryFn<typeof InputText> = args => {
  return (
    <div>
...
export const Autocomplete: StoryFn<typeof InputText> = args => {
  return (
...
const ControlledTemplate: StoryFn<typeof InputText> = args => {

...
const ActionTemplate: StoryFn<typeof Modal> = args => {
  const [modalOpen, setModalOpen] = useState(false);
...
const ModalWithProviderExampleTemplate: StoryFn<typeof Modal> = () => {
  const [modalOpen, setModalOpen] = useState(false);
...
export const ModalWithProviderExample = {
  render: ModalWithProviderExampleTemplate,
};

const NestedExampleTemplate: StoryFn<typeof Modal> = args => {

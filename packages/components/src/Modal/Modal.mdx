    ...
    return (
      <>
        <Modal
          ...
          secondaryAction={{ label: "Cancel", variation: "cancel", onClick: handleSecondaryAction }}
          tertiaryAction={{ label: "Delete", variation: "destructive", onClick: handleTertiaryAction }}

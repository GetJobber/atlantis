...
const ComboboxClearSelection: StoryFn<typeof Combobox> = args => {
...
const ComboboxCustomActivator: StoryFn<typeof Combobox> = args => {
  const [selected, setSelected] = useState<ComboboxOption[]>([]);
...
const ComboboxEmptyState: StoryFn<typeof Combobox> = args => {
  return (
...
const ComboboxPrefixOptions: StoryFn<typeof Combobox> = args => {
  const [selected, setSelected] = useState<ComboboxOption[]>([]);
...
const ComboboxMultiSelection: StoryFn<typeof Combobox> = args => {
  const [selected, setSelected] = useState<ComboboxOption[]>([]);
...
const ComboboxSingleSelection: StoryFn<typeof Combobox> = args => {
  const [selected, setSelected] = useState<ComboboxOption[]>([]);
...
const DynamicButton: StoryFn<typeof Combobox> = args => {
  const [selected, setSelected] = useState<ComboboxOption[]>([]);
...
const ComboboxCustomSearch: StoryFn<typeof Combobox> = args => {
  const [selected, setSelected] = useState<ComboboxOption[]>([]);
...
const ComboboxInfiniteScroll: StoryFn<typeof Combobox> = args => {
...
const ComboboxKeepOpenOnClick: StoryFn<typeof Combobox> = args => {
  const [selected, setSelected] = useState<ComboboxOption[]>([]);
...
const ComboboxCustomRenderOptions: StoryFn<typeof Combobox> = args => {

...
} as Meta<typeof ResponsiveSwitcher>;

const BasicTemplate: StoryFn<typeof ResponsiveSwitcher> = (
...
const MultipleItemsTemplate: StoryFn<typeof ResponsiveSwitcher> = (
  args: ResponsiveSwitcherProps,
) => {
  return (
    <Stack>
...
const CustomSpacingTemplate: StoryFn<typeof ResponsiveSwitcher> = (
  args: ResponsiveSwitcherProps,
) => {
  return (
    <Stack>

...
// import { MockedNavigator, wait } from "utils/test";
// import { Form } from "atlantis/Form";
// import { renderForm } from "atlantis/Form/test/renderForm";
...
//                 initialValues={{ [pickerName]: new Date(2022, 4, 29) }}
//               >
//                 <InputDate
//                   name={pickerName}
//                   onChange={handleChange}
...
//       const screen = await setup();
//       fireEvent.press(
//         screen.getByLabelText("Clear input", { includeHiddenElements: true }),
//       );

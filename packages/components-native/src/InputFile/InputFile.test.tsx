...
// import * as hooks from "hooks/useIsDeviceOnline/useIsDeviceOnline";
// import * as atlantisContext from "atlantis/AtlantisContext/AtlantisContext";
// import { defaultValues as contextDefaultValue } from "atlantis/AtlantisContext";
// import { FileUpload, InputFile } from ".";
// import { messages as messagesHook } from "./messages";
// import { FileSource, StatusCode } from "./types";

// jest.mock("./utils/uploadAssetToS3");
...
// const mockGetUploadParams = jest.fn().mockImplementation(_file => {
//   return {
...
//     return { camera: true, photoLibrary: true };
//   });
//   jestPick.mockImplementation(_options => {
...
//       return jest.fn();
//     });
//     const optionsSpy = jest.spyOn(JobberWebInterface, "openActionSheet");
...
//     beforeEach(() => {
//       jest
//         .spyOn(JobberWebInterface, "openActionSheet")
//         .mockImplementation(() => {
//           if (Platform.OS === "ios") {

...
const extravagantLineHeight = parseFloat(
  JobberStyle["typography--lineHeight-extravagant"],
);
const jumboLineHeight = parseFloat(JobberStyle["typography--lineHeight-jumbo"]);
const largestLineHeight = parseFloat(
  JobberStyle["typography--lineHeight-largest"],
);
const largerLineHeight = parseFloat(
  JobberStyle["typography--lineHeight-larger"],
);
const largeLineHeight = parseFloat(JobberStyle["typography--lineHeight-large"]);
const baseLineHeight = parseFloat(JobberStyle["typography--lineHeight-base"]);
const tightLineHeight = parseFloat(JobberStyle["typography--lineHeight-tight"]);
const minisculeLineHeight = parseFloat(
  JobberStyle["typography--lineHeight-miniscule"],
);

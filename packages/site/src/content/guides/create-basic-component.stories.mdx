...
✔  +! 5 files added
 ...
 -> /packages/components/src/AmountCounter/AmountCounter.stories.tsx
 -> /packages/components/src/AmountCounter/AmountCounter.test.tsx
 -> /packages/components/src/AmountCounter/AmountCounter.tsx
✔  +! 2 files added
 -> /packages/components-native/src/AmountCounter/AmountCounter.stories.tsx
 -> /packages/components/src/AmountCounter/AmountCounter.stories.tsx
```
...
| `AmountCounter.stories.tsx` | This file is where you will add the examples of your component. You can add as many examples as you want with different props implementations.                                                              |
...
[proposal docs directory](https://github.com/GetJobber/atlantis/tree/master/packages/site/src/docs/proposals)

...
such as ["destructive"](/design/colors#destructive) specify the system color for
the icon when it is added to Atlantis. In all other cases, use the default icon
color.

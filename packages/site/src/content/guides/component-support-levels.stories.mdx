...
* Will be removed in the next major version. Please prioritize removing existing usages of this component.
* We'll provide a migration guide to aid consumers in switching to an alternative.

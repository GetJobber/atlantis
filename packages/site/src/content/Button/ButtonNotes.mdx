...
[Web/Client Side Routing example](../?path=/story/components-actions-button--client-side-routing).
...
allowed. See
[Web/Form Submit example](../?path=/story/components-actions-button--form-submit)

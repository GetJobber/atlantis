...
A layout component that manages groups of elements with varying lengths in a
responsive, wrapped arrangement.

## Design & usage guidelines

The Cluster component is ideal for:

- Button groups at the end of forms
...
match your layout requirements, along with the justification of the cluster
itself with the `justify` prop.

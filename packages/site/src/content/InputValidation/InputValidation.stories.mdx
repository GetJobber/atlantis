...
<Banner type="warning" dismissible={false}>
  ...
  <a href="/components/InputText#validation-message">
...
[input's built-in validation](/components/InputText#validation-message) is not
available, such as in `inline` usage.

For more information about `validations` using any of the Input components, see
the [InputText](/components/InputText#validation-message) documentation.

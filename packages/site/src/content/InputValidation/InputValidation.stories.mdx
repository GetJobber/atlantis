...
<Banner type="warning" dismissible={false}>
  ...
  component&apos;s
  validation](/storybook/web/?path=/docs/components-forms-and-inputs-inputtext--docs#validation-message)
...
[input's built-in validation](/storybook/web/?path=/docs/components-forms-and-inputs-inputtext--docs#validation-message)
is not available, such as in `inline` usage.

For more information about `validations` using any of the Input components, see
the

[InputText](/storybook/web/?path=/docs/components-forms-and-inputs-inputtext--docs#validation-message)
documentation.

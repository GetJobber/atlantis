...
<Banner type="warning" dismissible={false}>
  ...
  <a href="../?path=/story/components-forms-and-inputs-inputtext-web--basic">
...
[input's built-in validation](../?path=/story/components-forms-and-inputs-inputtext-web--basic)
is not available, such as in `inline` usage.

For more information about `validations` using any of the Input components, see
the
[InputText](../?path=/story/components-forms-and-inputs-inputtext-web--basic)
documentation.

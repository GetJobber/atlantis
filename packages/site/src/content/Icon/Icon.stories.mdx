...
| <Icon name="franchiseIndividual" /> | `franchiseIndividual` |
| <Icon name="franchiseGroup" />      | `franchiseGroup`      |
| <Icon name="user" />                | `user`                |
...
| <Icon name="flash" />           | `flash`           |
| <Icon name="flashAuto" />       | `flashAuto`       |
| <Icon name="flashOff" />        | `flashOff`        |
| <Icon name="gift" />            | `gift`            |
| <Icon name="grid" />            | `grid`            |

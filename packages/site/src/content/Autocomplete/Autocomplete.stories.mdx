...
[Details](../?path=/story/components-forms-and-inputs-autocomplete--with-details)
...
[Section headings](../?path=/story/components-forms-and-inputs-autocomplete--section-heading)
...
You can
[set a value](../?path=/story/components-forms-and-inputs-autocomplete--set-a-value)

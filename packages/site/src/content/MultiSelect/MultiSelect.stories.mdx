...
<Banner type="warning" dismissible={false}>
  This component has been deprecated and no longer supported. Instead, please
  use [Autocomplete](/components/Autocomplete) with the "mutliple" prop, or
...
Adjusting the
[size](/storybook/web/?path=/story/components-selections-multiselect--sizes) of

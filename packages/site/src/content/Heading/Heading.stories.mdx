...
| `<Heading level={"heading"} />`    | Used to group content and forms on a single topic. Like `title` and `subtitle`, `heading` uses [Jobber Pro](/storybook/web/?path=/docs/design-typography--docs#font-families). |
| `<Heading level={"subHeading"} />` | Used to group small lists of content, `subHeading` uses the [Inter](/storybook/web/?path=/docs/design-typography--docs#base) font.                                             |
...
[Typography](/storybook/web/?path=/docs/components-text-and-typography-typography--docs#platform-considerations)
documentation.

...
| `<Heading level={"heading"} />`    | Used to group content and forms on a single topic. Like `title` and `subtitle`, `heading` uses [Jobber Pro](/design/typography#component-view-font-families). |
| `<Heading level={"subHeading"} />` | Used to group small lists of content, `subHeading` uses the [Inter](/design/typography#component-view-font-families) font.                                    |
...
under the [Typography](/components/Typography) documentation.

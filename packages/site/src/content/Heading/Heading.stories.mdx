...
| `<Heading level={"heading"} />`    | Used to group content and forms on a single topic. Like `title` and `subtitle`, `heading` uses [Jobber Pro](/design/typography#font-families). |
| `<Heading level={"subHeading"} />` | Used to group small lists of content, `subHeading` uses the [Inter](/design/typography#base) font.                                             |
...
under the
[Typography](../?path=/story/components-text-and-typography-typography-web--basic)
documentation.

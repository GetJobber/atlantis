...
If you're using Card with its composable subcomponents, you'll need to pass
...
>
  ...
  >
    <Text>Custom Styled Header</Text>
  </Card.Header>
  <Card.Body>
    <p>Card content with custom container styling</p>
  </Card.Body>
</Card>
```

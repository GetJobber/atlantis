...
| `titleMetaData={<Badge />}`            | `<Page.TitleMetaData><Badge /></Page.TitleMetaData>` inside `Page.Title`                            |
...
| `primaryAction={{ label, onClick }}`   | `<Page.PrimarySlot><Page.PrimaryAction label={label} onClick={onClick} /></Page.PrimarySlot>`       |
| `secondaryAction={{ label, onClick }}` | `<Page.SecondarySlot><Page.SecondaryAction label={label} onClick={onClick} /></Page.SecondarySlot>` |
| `moreActionsMenu={[...]}`              | `<Page.TertiarySlot><Page.Menu>...</Page.Menu></Page.TertiarySlot>`                                 |

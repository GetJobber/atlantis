...
<Canvas>
  <ContentBlock intrinsic justify="center">
    <Text>
      This text is rather long to showcase how intristic centering works. If
      elements within the ContentBlock component have less width than the
      longest item, they will naturally find the center of the widest item
    </Text>
    <Box padding="base">

...
✔  +! 5 files added
 ...
 -> /packages/components/src/ExampleComponent/ExampleComponent.stories.tsx
...
✔  +! 2 files added
 -> /packages/components-native/src/ExampleComponent/ExampleComponent.stories.tsx
 -> /packages/site/src/content/ExampleComponent/ExampleComponent.stories.mdx
```

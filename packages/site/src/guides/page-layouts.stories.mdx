...
<section>
 ...
 <Canvas>
  ...
  <Canvas>
  <Card>
    <Rectangle padding={{y: "18px",x:"67px"}}>
      <Stack>
        <Heading level={2}>Rectangle Offset Padding</Heading>
        <Text>You can modify the padding, in unequal increments, to meet specific design requirements but it's best to use the space tokens for consistent spacing where possible and striving for equal paddings everywhere else. Use offset padding only when necessary.</Text>
      </Stack>
    </Rectangle>
    </Card>
  </Canvas>
...
<Stack>
     ...
     <Text>Containers are for isolating styles to a specific layout. Set a container name, and apply associated styles where needed.</Text>
     <Text>We provide a set of predfined Containers and styles for common layout patterns.</Text>
          ...
          <Card>
            <Rectangle>
              <Stack>
                ...
                <Text>We've overridden the default styles without having to edit anything.</Text>
              </Stack>
            </Rectangle>
          </Card>
        </Container.Apply>
        <Container.Apply className={styles.itemDotted}>
          <Card>
            <Rectangle>
              <Stack>
                <Heading level={1}>Container Example</Heading>
                <Text>These cards are functionally identical except they have different content widths.</Text>
              </Stack>
            </Rectangle>
          </Card>
        </Container.Apply>
        <Container.Apply className={styles.itemUpsideDown}>
          <Card>
            <Rectangle>
              <Stack>
                <Heading level={1}>Container Example</Heading>
                <Text>They're also perfectly portable. Only here will you find a card with a rotated text. Copy this out and paste it anywhere else and it won't
                be rotated anymore.</Text>
              </Stack>
            </Rectangle>
          </Card>
        </Container.Apply>

...
import { FormField, FormFieldLabel } from "@jobber/components";
...
<Canvas>
  <Center align="left" maxWidth="1285px">
    <Box padding="base">
      <Stack space="larger">
        <SideKick
          contentMinWidth="40%"
...
<Canvas>
  ...
  <Disclosure title="Skeleton layout template">
      ```
        <Card accent="color">
...
<Heading level={3}>Request Create</Heading>
<Canvas>
  <Card>
    <Container name="form-container">
      <Container.Apply className={styles.formPadding}>
        <ResponsiveSwitcher threshold="40rem" space="largest">
          <Stack space="base">
            ...
            <Stack space="base">
              ...
              <Text variation="subdued">Which day would be best for an assessment of the work?</Text>
              <InputDate placeholder={"Date"} />
              <Text variation="subdued">What is another day that works for you?</Text>
               <InputDate placeholder={"Date"}/>
              <Text variation="subdued">What are your preferred arrival times?</Text>
              <Stack space="small">
  ...
  <Card>
    <Box padding="large">
      <Stack space="base">
        ...
        <InputText multiline rows={4} placeholder="Description" />
        <Box
          background="surface--background--subtle"
          padding="base"
          radius="base"
        ...
        >
          <Stack align="center" space="smaller">

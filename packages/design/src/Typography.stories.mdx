...
| Name                                 | Visual                             | Value |
| :----------------------------------- | :--------------------------------- | :---- |
| `--typography--fontSize-smallest`    | <MobileExample of="smallest" />    | 10px  |
| `--typography--fontSize-smaller`     | <MobileExample of="smaller" />     | 12px  |
| `--typography--fontSize-small`       | <MobileExample of="small" />       | 14px  |
| `--typography--fontSize-base`        | <MobileExample of="base" />        | 16px  |
| `--typography--fontSize-large`       | <MobileExample of="large" />       | 18px  |
| `--typography--fontSize-larger`      | <MobileExample of="larger" />      | 20px  |
| `--typography--fontSize-largest`     | <MobileExample of="largest" />     | 24px  |
| `--typography--fontSize-jumbo`       | <MobileExample of="jumbo" />       | 32px  |
| `--typography--fontSize-extravagant` | <MobileExample of="extravagant" /> | 42px  |

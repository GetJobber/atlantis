...
import { JobberStyle } from "@jobber/design/foundation.native.js";
...
export function MobileExample({ of: mobileSize }) {
  const style = {
    fontSize: JobberStyle[`typography--fontSize-${mobileSize}`],
    fontFamily: "Inter",
  };
...
export function MobilePixelSize({ of: mobileSize }) {
  const value = JobberStyle[`typography--fontSize-${mobileSize}`] + "px";
  return value;
}
...
export function MobileLineHeightExample({ of: mobileLineHeight }) {
  const style = {
    lineHeight:
      JobberStyle[`typography--lineHeight-${mobileLineHeight}`] + "px",
    fontFamily: "Inter",
  };
  console.log(JobberStyle, mobileLineHeight);
  return (
    <div style={style}>
      Line-height, or leading, is the space between subsequent lines of type...
    </div>
...
export function MobileLineHeightPixelSize({ of: mobileSize }) {
  const value = JobberStyle[`typography--lineHeight-${mobileSize}`] + "px";
  return value;
}

...
| Name                                 | Visual                                                                  | Value |
| :----------------------------------- | :---------------------------------------------------------------------- | :---- |
| `--typography--fontSize-smallest`    | <div style={{fontSize: "10px", fontFamily: "Inter"}}>smallest </div>    | 10px  |
| `--typography--fontSize-smaller`     | <div style={{fontSize: "12px", fontFamily: "Inter"}}>smaller </div>     | 12px  |
| `--typography--fontSize-small`       | <div style={{fontSize: "14px", fontFamily: "Inter"}}>small </div>       | 14px  |
| `--typography--fontSize-base`        | <div style={{fontSize: "16px", fontFamily: "Inter"}}>base </div>        | 16px  |
| `--typography--fontSize-large`       | <div style={{fontSize: "18px", fontFamily: "Inter"}}>large </div>       | 18px  |
| `--typography--fontSize-larger`      | <div style={{fontSize: "20px", fontFamily: "Inter"}}>larger </div>      | 20px  |
| `--typography--fontSize-largest`     | <div style={{fontSize: "24px", fontFamily: "Inter"}}>largest </div>     | 24px  |
| `--typography--fontSize-jumbo`       | <div style={{fontSize: "32px", fontFamily: "Inter"}}>jumbo </div>       | 32px  |
| `--typography--fontSize-extravagant` | <div style={{fontSize: "42px", fontFamily: "Inter"}}>extravagant </div> | 42px  |
...
| Name                                   | Visual                                                                                                                                                       | Value |
| :------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------- | :---- |
| `--typography--lineHeight-extravagant` | <div style={{lineHeight: "42px", fontFamily: "Inter"}}>Line-height, or leading, is the space between subsequent lines of type. The line-heights in... </div> | 42px  |
| `--typography--lineHeight-jumbo`       | <div style={{lineHeight: "36px", fontFamily: "Inter"}}>Line-height, or leading, is the space between subsequent lines of type. The line-heights in... </div> | 36px  |
| `--typography--lineHeight-largest`     | <div style={{lineHeight: "28px", fontFamily: "Inter"}}>Line-height, or leading, is the space between subsequent lines of type. The line-heights in... </div> | 28px  |
| `--typography--lineHeight-larger`      | <div style={{lineHeight: "24px", fontFamily: "Inter"}}>Line-height, or leading, is the space between subsequent lines of type. The line-heights in... </div> | 24px  |
| `--typography--lineHeight-large`       | <div style={{lineHeight: "22px", fontFamily: "Inter"}}>Line-height, or leading, is the space between subsequent lines of type. The line-heights in... </div> | 22px  |
| `--typography--lineHeight-base`        | <div style={{lineHeight: "20px", fontFamily: "Inter"}}>Line-height, or leading, is the space between subsequent lines of type. The line-heights in... </div> | 20px  |
| `--typography--lineHeight-tight`       | <div style={{lineHeight: "18px", fontFamily: "Inter"}}>Line-height, or leading, is the space between subsequent lines of type. The line-heights in... </div> | 18px  |

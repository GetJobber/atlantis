...
[Button.](../?path=/docs/components-button--button#icons)
...
[Chips in a selection group.](../?path=/docs/components-chips--chips#single-select)
...
children of their own, such as [Card.](../?path=/docs/components-card--card)
This should also be used as the default starting point for spacing between
[Form](../?path=/docs/components-form--form) elements.
...
[Modal](../?path=/docs/components-modal--modal) uses `large` spacing in its
header and around the edges to give itself a bit more prominence as a
"standalone" view, in a similar manner to
[Page](../?path=/docs/components-page--page).
...
Use the [Content component](../?path=/docs/components-content--content) for any
instances where you need uniform spacing between elements.

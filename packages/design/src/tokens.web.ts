export default {
  ...
  "shadow-low":
    "0px 1px 2px rgba(0, 0, 0, 0.25), 0px 0px 2px rgba(0, 0, 0, 0.1)",
  "shadow-base":
    "0px 1px 4px 0px rgba(0, 0, 0, 0.1), 0px 4px 12px 0px rgba(0, 0, 0, 0.05)",
  "shadow-high":
    "0px 16px 16px 0px rgba(0, 0, 0, 0.075), 0px 0px 8px 0px rgba(0, 0, 0, 0.05)",
  "shadow-focus":
  ...
  "typography--fontSize-jumbo": "32px",

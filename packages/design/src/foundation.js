module.exports = {
  customProperties: {
    ...
    "--color-focus": "var(--color-greyBlue--light)",
    ...
    "--typography--fontFamily-display":
      '"Jobber Pro", "Poppins", Helvetica, Arial,\n    sans-serif',
    "--typography--fontSize-extravagant":
      "calc(\n    var(--typography--fontSize-large) * 3\n  )",
    "--typography--fontSize-jumbo":
      "calc(var(--typography--fontSize-large) * 2.25)",
    "--typography--fontSize-largest":
      "calc(var(--typography--fontSize-large) * 1.5)",
    "--typography--fontSize-larger":
      "calc(var(--typography--fontSize-large) * 1.25)",
    "--typography--fontSize-large": "calc(var(--base-unit) * 1)",
    "--typography--fontSize-base":
      "calc(var(--typography--fontSize-large) * 0.875)",
    "--typography--fontSize-small":
      "calc(var(--typography--fontSize-large) * 0.75)",

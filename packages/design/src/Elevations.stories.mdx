...
they map to our low/base/high pattern. These tokens apply to both web and mobile
applications.
...
When using the mobile tokens imported from `foundation.native`, the shadow
tokens will be resolved to apply to either android or iOS devices automatically.

...
[Buttons](../?path=/docs/components-button--button) where the interactive color
is functioning as a background color or the text color, the alternative color
...
such as a [Modal](../?path=/docs/components-modal--modal)’s appearance. Overlay

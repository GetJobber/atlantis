...
<a href="../?path=/docs/components-button--button">Buttons</a> where the interactive
color is functioning as a background color or the text color, the alternative color
should be `--color-white`\*.
...
such as a <a href="../?path=/docs/components-modal--modal">Modal</a>’s
appearance. Overlay includes built-in opacity values.
...
<a href="../?path=/docs/design-borders--page">Borders guide</a>.

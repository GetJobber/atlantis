export default {
  ...
  "shadow-low": "0 1px 2px rgba(0, 0, 0, 0.25), 0px 0px 2px rgba(0, 0, 0, 0.1)",
  "shadow-base":
    "0 1px 4px 0px rgba(0, 0, 0, 0.1), 0px 4px 12px 0px rgba(0, 0, 0, 0.05)",
  "shadow-high":
    "0 16px 16px 0px rgba(0, 0, 0, 0.075), 0px 0px 8px 0px rgba(0, 0, 0, 0.05)",
  "shadow-focus":
    "0 0px 0px 2px rgba(255, 255, 255, 1), 0px 0px 0px 4px hsl(198, 12%, 57%)",
  "timing-quick": 100,
  "timing-base": 200,
  "timing-slow": 300,
  "timing-slower": 400,

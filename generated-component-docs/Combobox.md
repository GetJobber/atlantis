...
| `onSearch`                                                        | `(searchValue: string) => void`              | ❌       | `_none_` | Debounced callback function invoked on Combobox search input change. Receives the current search value as an argument. |
